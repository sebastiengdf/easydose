 ...
 * CmsListSeo
 *
 * @ORM\Table(name="cms_list_seo", uniqueConstraints={@ORM\UniqueConstraint(name="UNIQ_171CBCE05E15A06E", columns={"unique_slug"}), @ORM\UniqueConstraint(name="UNIQ_171CBCE0989D9B62", columns={"slug"})}, indexes={@ORM\Index(name="IDX_171CBCE08C22AA1A", columns={"layout_id"}), @ORM\Index(name="IDX_171CBCE08D0886C5", columns={"cover"})})
 * @ORM\Entity
 */
class CmsListSeo
{
